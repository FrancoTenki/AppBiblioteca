...
import com.example.bibliotecavirtual.daos.BookDAOS;
import com.example.bibliotecavirtual.daos.DaosDataBase;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // daos database
        DaosDataBase appdata=DaosDataBase.getInstance(this);
        BookDAOS bookDAOS=appdata.bookDAOS();

        List<Book>books=bookDAOS.getAll();
        filteredBookList.addAll(books);


        Log.i("Main_APP", "Lista de daosbook: " + bookList);
        ...
        service.getBooks().enqueue(new Callback<List<Book>>() {
            ...
            public void onResponse(Call<List<Book>> call, Response<List<Book>> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Log.i("Main_APP", "Lista de daosbook: " + response.body());
                    for (Book book:response.body()){
                        Book localbook=book;
                        bookDAOS.insert(localbook);
